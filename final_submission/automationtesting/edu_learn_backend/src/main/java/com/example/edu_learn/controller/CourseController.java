...
public class CourseController {
    ...
    public Course createCourse(@RequestBody Course course, @PathVariable Long instructorId, Authentication authentication) {
    ...
    public Course enrollInCourse(@PathVariable Long courseId, @PathVariable Long studentId, Authentication authentication) {
        // UserDetailsImpl userDetails = (UserDetailsImpl) authentication.getPrincipal();
        // if (!userDetails.getRole().equals("STUDENT")) {
        //     throw new RuntimeException("Only students can enroll in courses");
        // }
        return courseService.enrollInCourse(courseId, studentId);
    }
